...
#define N     64
#define Z     4000           // iteraciones, deberían ser 27000
...
double *masa_l, s_sigma, *zetas, *tamanios_s1, *tamanios_s2, *tamanios_s3, *tamanios_s4, *tamanios_s5, *tamanios_s6, *tamanios_s7, *tamanios_s8, ns1_pc, ns2_pc, ns3_pc, ns4_pc, ns5_pc, ns6_pc, ns7_pc, ns8_pc;
char   file[10];
...
for(i=0;i<z;i++){
	...
	ns1_pc = (double)*(tamanios+5)/(double)z;
	ns2_pc = (double)*(tamanios+7)/(double)z;
	ns3_pc = (double)*(tamanios+9)/(double)z;
	ns4_pc = (double)*(tamanios+11)/(double)z;
	ns5_pc = (double)*(tamanios+13)/(double)z;
	ns6_pc = (double)*(tamanios+15)/(double)z;
	ns7_pc = (double)*(tamanios+17)/(double)z;
	ns8_pc = (double)*(tamanios+19)/(double)z;
...
tamanios_s4 = (double *)malloc(ps*sizeof(double));
tamanios_s5 = (double *)malloc(ps*sizeof(double));
tamanios_s6 = (double *)malloc(ps*sizeof(double));
tamanios_s7 = (double *)malloc(ps*sizeof(double));
tamanios_s8 = (double *)malloc(ps*sizeof(double));
...
paso = 1.0/ps;
*linspace_prob = 0.0; // despues divido por pc así que cuidado
*zetas = -s_sigma;
for(i=1; i<ps; i++){
...
for(i=0;i<ps; i++){
	...
	for(j=0; j<z; j++){
		...
		*(tamanios_s1+i) += (double)*(tamanios+5)/(double)z/ns1_pc;
		*(tamanios_s2+i) += (double)*(tamanios+7)/(double)z/ns2_pc;
		*(tamanios_s3+i) += (double)*(tamanios+9)/(double)z/ns3_pc;
		*(tamanios_s4+i) += (double)*(tamanios+11)/(double)z/ns4_pc;
		*(tamanios_s5+i) += (double)*(tamanios+13)/(double)z/ns5_pc;
		*(tamanios_s6+i) += (double)*(tamanios+15)/(double)z/ns6_pc;
		*(tamanios_s7+i) += (double)*(tamanios+17)/(double)z/ns7_pc;
		*(tamanios_s8+i) += (double)*(tamanios+19)/(double)z/ns8_pc;
		}
	}

exportar_vector(tamanios_s1, ps, "tamanios_s1.txt");
exportar_vector(tamanios_s2, ps, "tamanios_s2.txt");
exportar_vector(tamanios_s3, ps, "tamanios_s3.txt");
exportar_vector(tamanios_s4, ps, "tamanios_s4.txt");
exportar_vector(tamanios_s5, ps, "tamanios_s5.txt");
exportar_vector(tamanios_s6, ps, "tamanios_s6.txt");
exportar_vector(tamanios_s7, ps, "tamanios_s7.txt");
exportar_vector(tamanios_s8, ps, "tamanios_s8.txt");
exportar_vector(zetas, ps, "zetas.txt");
